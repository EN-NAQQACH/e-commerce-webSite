            ...
            <div className='products-container flex md:justify-between justify-center lg:px-24 py-6  gap-7 flex-wrap  '>
                <div className='product-content sm:w-[45%] lg:w-[22%] h-fit flex flex-col gap-2'>
                    <div className='h-[250px] relative'>
                        <img src="./product.jpg" alt="" className='w-full h-full absolute z-10 hover:opacity-0 transition-all duration-100 rounded-sm object-cover' />
                        <img src="./product1.jpg" alt="" className='w-full h-full absolute  rounded-sm object-cover' />
                    </div>
                ...
                <div className='product-content sm:w-[45%] lg:w-[22%] h-fit flex flex-col gap-2'>
                    <div className='h-[250px]'>
                        <img src="./product.jpg" alt="" className='w-full h-full rounded-sm object-cover' />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <div className='font-bold text-[14px] te flex justify-between'>
                            <p>Digital Incense</p>
